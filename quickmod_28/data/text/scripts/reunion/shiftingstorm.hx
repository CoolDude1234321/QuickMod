...
if(_command == "execute"){
  ...
  _e.changecolour("red");
  _e.fulldescription = "Do [fire]" + _damage + "[comma] inflict [fire]1 burn[newline](changes each turn...)[newline][gray](Reuseable)";
}else if(_command == "startturn"){
  _e.animate("flashandshake");
  sfx("_thinghappens");
  ...
  if(randstatus == "fire"){ 
    ...
    _e.changecolour("brightcyan");
    _e.fulldescription = "Do [ice]" + _damage + "[comma] inflict [ice]1 freeze[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "shock"){ 
    _e.changecolour("yellow");
    _e.fulldescription = "Do [shock]" + _damage + "[comma] inflict [shock]1 shock[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "weaken"){ 
    _e.changecolour("orange");
    _e.fulldescription = "Do [weaken]" + _damage + "[comma] inflict [weaken]1 weaken[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "poison"){ 
    _e.changecolour("purple");
    _e.fulldescription = "Do [sword]" + _damage + "[comma] inflict [poison]1 poison[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "blind"){ 
    _e.changecolour("purple");
    _e.fulldescription = "Do [sword]" + _damage + "[comma] inflict [blind]1 blind[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "curse"){ 
    _e.changecolour("purple");
    _e.fulldescription = "Do [sword]" + _damage + "[comma] inflict [curse]1 curse[newline](changes each turn...)[newline][gray](Reuseable)";
  }else if(randstatus == "lock"){ 
    _e.changecolour("purple");
    _e.fulldescription = "Do [sword]" + _damage + "[comma] lock [lock]1 dice[newline](changes each turn...)[newline][gray](Reuseable)";
  }
}