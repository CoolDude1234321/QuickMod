...
var commonlist_offensive = [rand(["Life Drain", "Healing Crystal"]), "Slime Ball", "Magic Dagger", "Fury Spell", "Magic Spear","Hex","Catastrophe"];
var commonlist_dicemanipulation = ["Illuminate", "Glass Cauldron", "Gold Cauldron", "Silver Cauldron", "Innovate", "Counter Spell","Rat"];
if(chance(20)){
