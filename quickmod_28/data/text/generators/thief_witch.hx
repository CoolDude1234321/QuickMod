// TODO: Everything
// This just copies warrior's generator for testing purposes with the main gimmick
// So PLEASE, next serve, please edit this to be balanced for thief witch!!

var warriorshops = ["Broadsword", "Iron Shield", "Nunchuck Eyes", "Clocktower", "Target Shield", "Cawtastrophe", "Unbalanced Item", "Midnight Charm", "Disgusting Exit", "Law", "R[dash]R[dash]Freezerator", "Boomerang", "Rap", "Jam Cannon", "Tennis Dungeons Mod"];
var strangeshop = ["Spannaargh", "Larry Bash", "Sidegrade Hammer", "Juggling Discoball"];
var awesomelist = ["Whip", "Grammar", "Law", "Rude Staff", "Wrench@lol", "Bongo", "Flip[hyphen]Flop"];
...
lastfloor
  ...
  .setlocation('BOSS')
  .addotherstuff(otherstuff, goodotherstuff);
lastfloor.theme = pick(["music_boss_beatrice", "music_boss_buster"]);
lastfloor.generate();